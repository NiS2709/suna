...
class SearchAPIsStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        if has_existing:
            ...
            self.info(
                "Search APIs are OPTIONAL tools that enhance Nexus's capabilities."
            )
            self.info(
                "Without these, Nexus will work but won't have web search or scraping functionality."
            )
    ...
    def _show_summary(self) -> None:
        ...
        if configured:
            ...
            self.info(
                "No search tools configured - Nexus will work without web search capabilities."
            )
