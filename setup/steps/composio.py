...
class ComposioStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        if has_existing:
            ...
            self.info("Composio is REQUIRED for Nexus. Without this key, Composio features will fail.")
            self.info("Composio provides tools and integrations for Nexus agents.")
