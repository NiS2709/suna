...
class SetupMethodStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        self.info(
            "You can start Nexus using either Docker Compose or by manually starting the services."
        )
        ...
        self.info("Want to fix this? See: https://github.com/NiS2709/nexus/issues/1920")
        ...
        self.console.print("\nHow would you like to set up Nexus?")
