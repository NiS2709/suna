...
class LLMProvidersStep(BaseStep):
    ...
    # Main LLM provider options for nexus/basic and nexus/power models
    ...
    def _configure_main_provider(self) -> None:
        """Configure the main LLM model (required for nexus/basic)."""
        self.console.print("\n" + "=" * 60)
        self.console.print("[bold]Main LLM Model Selection[/bold]")
        self.console.print("=" * 60)
        self.info("Nexus requires a main LLM to power 'nexus/basic' and 'nexus/power'.")
        self.console.print("")
    ...
    def _collect_required_key(self, env_key: str, provider_name: str) -> None:
        ...
        while True:
            ...
            if api_key:
                ...
                self.error(f"{provider_name} API key is REQUIRED for Nexus to function.")
