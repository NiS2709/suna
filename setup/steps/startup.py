...
class StartupStep(BaseStep):
    ...
    def run(self) -> StepResult:
        ...
        self.info("\nHow would you like to start Nexus?")
    ...
    def _start_docker(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting Nexus with Docker Compose...")
            ...
            try:
                ...
                if "backend" in result.stdout and "frontend" in result.stdout:
                    self.success("Nexus services are starting up!")
                else:
                    self.warning(
    ...
    def _start_manual(self, choice: str, compose_cmd_str: str) -> StepResult:
        ...
        if choice == "1":
            ...
            self.info("Starting Nexus automatically (manual mode)...")
            ...
            try:
                ...
                self.success("Nexus services started!")
                self.info("Access Nexus at: http://localhost:3000")
                self.info("\nTo view logs:")
