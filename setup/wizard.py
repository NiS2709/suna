...
from setup.steps.nexus import NexusStep
...
class SetupWizard:
    ...
    def _sync_step_completion(self) -> None:
        ...
        optional_steps = ["morph", "search_apis", "rapidapi", "nexus", "webhook", "mcp"]
    ...
    def run(self) -> int:
        ...
        self.console.print(
            "This wizard will guide you through setting up Nexus, "
    ...
    def _show_final_instructions(self) -> None:
        ...
        self.console.info("Nexus is configured with your API keys and ready to use.")
        ...
        if self.config.setup_method == SetupMethod.DOCKER:
            self.console.info("Your Nexus instance is ready to use!")
            ...
            self.console.info("To start Nexus, run these commands in separate terminals:")
        ...
        self.console.print("\nOnce all services are running, access Nexus at: http://localhost:3000")
