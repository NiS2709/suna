# Nexus Agent Evaluations

Evaluate Nexus agent performance using **Braintrust** with JSON-based test cases.
...
Results are automatically uploaded to: https://www.braintrust.dev/app/Nexus/p/Nexus%20Agent/experiments/
...
| `EVAL_MODEL` | Override model for evals (default: `nexus/basic`) |
