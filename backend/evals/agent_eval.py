...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Run Nexus Agent evaluations",
...
Examples:
    ...
    parser.add_argument(
        "-m", "--model",
        type=str,
        default=os.getenv("EVAL_MODEL", "nexus/basic"),
        help="Model to use (default: nexus/basic)"
    )
...
""")
    ...
    # Run evaluation
    Eval(
        "Nexus Agent",  # Project name in Braintrust
        data=get_eval_data,
