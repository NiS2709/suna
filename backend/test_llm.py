...
Tests nexus/basic and nexus/power models with the configured MAIN_LLM provider.
"""
...
async def main():
    ...
    print("\n[nexus/basic]")
    basic_model = print_model_info("nexus/basic")
    
    print("\n[nexus/power]")
    power_model = print_model_info("nexus/power")
    
    print("\n[nexus/grok-4-1-fast]")
    grok_model = print_model_info("nexus/grok-4-1-fast")
    ...
    print("\n[Testing nexus/basic]")
    basic_ok = await test_llm_call("nexus/basic")
    
    print("\n[Testing nexus/power]")
    power_ok = await test_llm_call("nexus/power")
    ...
    print("Summary")
    print("=" * 60)
    print(f"  nexus/basic:  {'✓ PASS' if basic_ok else '❌ FAIL'}")
    print(f"  nexus/power:  {'✓ PASS' if power_ok else '❌ FAIL'}")
    print()
