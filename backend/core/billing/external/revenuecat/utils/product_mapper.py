...
class ProductMapper:
    PRODUCT_MAPPING = {
        'nexus_plus_monthly': 'tier_2_20',
        'nexus_plus_yearly': 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',
        'plus:plus-monthly' : 'tier_2_20',

        'nexus_pro_monthly': 'tier_6_50',
        'nexus_pro_yearly': 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',
        'pro:pro-monthly' : 'tier_6_50',
        
        'nexus_ultra_monthly': 'tier_25_200',
        'nexus_ultra_yearly': 'tier_25_200',
