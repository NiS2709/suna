...
class EmailService:
    def __init__(self):
        ...
        self.sender_email = os.getenv('MAILTRAP_SENDER_EMAIL', 'hey@nexus.com')
        self.sender_name = os.getenv('MAILTRAP_SENDER_NAME', 'Nexus Team')
        self.hello_email = 'hello@nexus.com'
    ...
    def send_referral_email(
        ...
        try:
            ...
            mail = mt.Mail(
                sender=mt.Address(email=sender_email_to_use, name='Nexus'),
...
<body>
  <div class="container">
    <div class="logo-container">
      <img src="https://heprlhlltebrxydgtsjs.supabase.co/storage/v1/object/public/image-uploads/loaded_images/Profile%20Picture%20Black.png" alt="Nexus Logo" class="logo">
    </div>

    <p>Hi {user_name},</p>

    <p><em><strong>Welcome to <a href="https://www.nexus.com/">Nexus.com</a> — we're excited to have you on board!</strong></em></p>
    ...
    <p>Thanks again, and welcome to the Nexus community!</p>
  </div>
</body>
</html>"""
...
Welcome to https://www.nexus.com/ — we're excited to have you on board!
...
Thanks again, and welcome to the Nexus community!

---
© 2025 Nexus. All rights reserved.
You received this email because you signed up for a Nexus account."""
  ...
  <tr>
    <td>
      ...
      <p style="margin:0 0 20px 0; font-size:15px; line-height:1.6;">
        <strong>{sender_name}</strong> has invited you to join Nexus using a personal referral code.
    ...
    <tr>
      <td>
        <div style="text-align: center; margin-bottom: 40px;">
          <img src="https://nexus.com/Logomark.svg" alt="Nexus" style="height: 24px; width: auto; display: inline-block;" />
        </div>
        ...
        <div style="text-align: center; margin-top: 32px;">
          <p style="font-size: 12px; color: #999; margin: 0;">
            &copy; Nexus AI Corp. All rights reserved.
          </p>
        </div>
      </td>
    </tr>
...
{sender_name} has invited you to join Nexus using a personal referral code.
...
---
© Nexus AI Corp. All rights reserved."""
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #fafafa; color: #1a1a1a;">
  <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 520px; margin: 0 auto; padding: 40px 20px;">
    ...
    def _get_otp_email_text(self, otp_code: str) -> str:
        return f"""Your Nexus verification code
