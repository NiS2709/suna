...
class NexusDefaultAgentTemplateError(Exception):
    pass
...
class TemplateService:
    ...
    async def create_from_agent(
        ...
        if self._is_nexus_default_agent(agent):
            raise NexusDefaultAgentTemplateError("Cannot create template from Nexus default agent")
    ...
    async def get_public_templates(
        self,
        is_nexus_team: Optional[bool] = None,
        ...
        if is_nexus_team is not None:
            query = query.eq('is_nexus_team', is_nexus_team)
    ...
    def _is_nexus_default_agent(self, agent: Dict[str, Any]) -> bool:
        metadata = agent.get('metadata', {})
        return metadata.get('is_nexus_default', False)
    ...
    def _map_to_template(self, data: Dict[str, Any]) -> AgentTemplate:
        ...
        return AgentTemplate(
            ...
            is_nexus_team=data.get('is_nexus_team', False),
