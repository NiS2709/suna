...
class InstallationService:
    ...
    async def _create_agent(
        ...
        if template.is_nexus_team:
            metadata['is_nexus_team'] = True
            metadata['nexus_template_id'] = template.template_id
        ...
        logger.debug(f"Created agent {agent_id} from template {template.template_id}, is_nexus_team: {template.is_nexus_team}")
        return agent_id
