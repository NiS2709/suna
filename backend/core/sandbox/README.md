...
2. Build a custom image:
   ...
   docker push nexus/nexus:0.1.3.30
   ```
...
1. Change the `image` parameter in `docker-compose.yml` (that defines the image name `nexus/nexus:___`)
...
3. Push the new version: `docker push nexus/nexus:0.1.3`
