...
def build_analysis_prompt(existing_categories: List[str]) -> str:
    ...
    return f"""You are analyzing conversations from Nexus, an open-source AI agent platform.

## ABOUT NEXUS
Nexus is a generalist AI agent that can:
...
Users interact with Nexus to accomplish real-world tasks like research, content creation, data analysis, coding, and automation.
...
## FRUSTRATION SIGNALS (Nexus-specific)
