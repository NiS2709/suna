...
NEXUS_HELLO_EMAIL = 'hello@nexus.com'
...
class NotificationService:
    ...
    async def send_task_completion_notification(
        ...
        try:
            ...
            task_url = f"https://www.nexus.com/projects/{project_id}/thread/{thread_id}" if project_id else f"https://www.nexus.com/thread/{thread_id}"
