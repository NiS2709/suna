...
export const AgentAvatar: React.FC<AgentAvatarProps> = ({
  ...
  isNexusDefault: propIsNexusDefault,
  ...
  const isNexus = propIsNexusDefault ?? agent?.metadata?.is_nexus_default;
  ...
  if (!agent && !propIconName && !propIsNexusDefault && agentId) {
    return (
      <div
