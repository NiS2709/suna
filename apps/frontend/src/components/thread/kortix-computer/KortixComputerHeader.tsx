...
interface NexusComputerHeaderProps {
...
/**
 * Shared header component for all Nexus Computer views (Files, File Viewer, Browser).
 ...
 */
export function NexusComputerHeader({
  icon: Icon,
  onIconClick,
  iconTitle,
  title,
