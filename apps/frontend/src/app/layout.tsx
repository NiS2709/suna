...
export const metadata: Metadata = {
  ...
  authors: [{ name: 'Nexus Team', url: 'https://www.nexus.com' }],
  creator: 'Nexus Team',
  ...
  return (
    <html lang="en" suppressHydrationWarning className={`${roobert.variable} ${roobertMono.variable}`}>
      <head>
        ...
        <title>Nexus: Your Autonomous AI Partner</title>
        ...
        <meta name="keywords" content="Nexus, AI Worker, Agentic AI, Autonomous AI Worker, AI Automation, AI Workflow Automation, AI Assistant, Task Automation" />
        <meta property="og:title" content="Nexus: Your Autonomous AI Partner" />
        ...
        <meta property="og:image" content="https://nexus.com/banner.png" />
        <meta property="og:url" content="https://nexus.com" />
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="Nexus" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Nexus: Your Autonomous AI Partner" />
        ...
        <meta name="twitter:image" content="https://nexus.com/banner.png" />
        ...
        {!featureFlags.disableMobileAdvertising ? (
          <meta name="apple-itunes-app" content="app-id=6754448524, app-argument=nexus://" />
        ) : null}
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: ['Nexus', 'Nexus AI', 'Nexus: Your Autonomous AI Partner'],
              url: siteMetadata.url,
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [siteMetadata.name, 'Nexus'],
