            ...
            <div className="relative z-10 pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
              <div className="flex flex-col items-center justify-center gap-6 pt-12 max-w-4xl mx-auto pb-16">
                ...
                <p className="text-sm text-muted-foreground">
                  Or email us directly at <a href="mailto:support@nexus.com" className="text-primary hover:underline font-medium">support@nexus.com</a>
                </p>
              </div>
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border">
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <a href="mailto:support@nexus.com" className="text-primary hover:underline font-medium">
                      Contact us
                    </a>
                  </div>
                </div>
            ...
            <div className="max-w-6xl mx-auto border-l border-r border-border">
              ...
              <div className="border-t border-border">
                <FAQItem
                  ...
                  answer="Nexus is a generalist AI worker that can perform real-world tasks on your behalf. Unlike traditional AI assistants, Nexus can actually take action across your apps, automate workflows, and handle complex multi-step tasks autonomously."
                />
                <FAQItem
                  question="How can Nexus help me?"
                  answer="Nexus can automate repetitive tasks, manage your workflows, interact with web services, process data, create content, and coordinate complex operations across multiple platforms. Simply tell Nexus what you need done, and it handles the execution from start to finish."
                />
                <FAQItem
                  question="How is Nexus different from other AI platforms?"
                  answer="While most AI platforms only provide information or suggestions, Nexus actually performs real-world tasks. It can browse the web, interact with APIs, manage files, execute commands, and integrate with your existing tools to complete tasks autonomously—not just tell you how to do them."
                />
                <FAQItem
                  question="Can Nexus connect to my apps?"
                  answer="Yes! Nexus can connect to thousands of apps and services through integrations. It can interact with your tools, APIs, databases, and workflows to automate tasks across your entire tech stack. You control which apps and services Nexus can access."
                />
                <FAQItem
                  question="How do I request a new feature?"
                  answer={
                    <>
                      We love feature requests! Email us at <a href="mailto:support@nexus.com" className="text-primary hover:underline font-medium">support@nexus.com</a> with details about what you'd like to see and how it would help you. We carefully review all suggestions and prioritize features based on user feedback for our product roadmap.
                    </>
                  }
                />
                <FAQItem
                ...
                <FAQItem
                  ...
                  answer={
                    <>
                      If your credits don't appear after payment, contact <a href="mailto:support@nexus.com" className="text-primary hover:underline font-medium">support@nexus.com</a> immediately. We prioritize billing and credit issues for all users regardless of tier and will resolve this as quickly as possible, typically within a few hours during business days.
                    </>
                  }
                />
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 border-t border-border">
                <div className="p-8 border-r border-border space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Our terms and conditions for using Nexus services, including user responsibilities and service limitations.
                    </p>
                ...
                <div className="p-8 space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground text-sm mb-4">
                      Company information and legal details about Nexus AI Corp, including contact information and registration.
                    </p>
          ...
          <div className="relative w-full px-6 py-16">
            <div className="max-w-4xl mx-auto text-center space-y-6">
              ...
              <div className="pt-6 space-y-2">
                <p className="text-sm text-muted-foreground">
                  General Inquiries: <a href="mailto:info@nexus.com" className="text-primary hover:underline">info@nexus.com</a>
                </p>
                <p className="text-sm text-muted-foreground">
                  Security Issues: <a href="mailto:security@nexus.com" className="text-primary hover:underline">security@nexus.com</a>
                </p>
              </div>
            </div>
          </div>
