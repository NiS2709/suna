...
interface Slide {
  ...
  bulletPoints?: string[];
  accent?: string;
  diagram?: 'agent-loop' | 'nexus-stack' | 'task-types' | 'token-flow' | 'messages-array' | 'sandbox-arch' | 'tools-overview';
...
const slides: Slide[] = [
  ...
  },
  {
    ...
    subtitle: 'CEO & COO at Nexus',
  },
  {
    id: 3,
    type: 'title',
    title: 'Demo',
    subtitle: 'Let\'s see Nexus in action',
  },
      ...
      {slide.type === 'diagram' && (
        <div className="w-full max-w-4xl">
          ...
          >
            ...
            {slide.diagram === 'nexus-stack' && <NexusStackDiagram />}
