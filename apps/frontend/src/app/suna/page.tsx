...
export const metadata: Metadata = {
  title: 'Nexus is now Nexus | Nexus - Open Source AI Worker',
  description: 'Nexus has rebranded to Nexus. Nexus (formerly Nexus) is the same powerful open source AI assistant and generalist AI worker you know and love, now with a new name and bigger vision.',
  keywords: [
    'Nexus',
    'Nexus',
    'Nexus AI',
  ...
  openGraph: {
    title: 'Nexus is now Nexus',
    description: 'Nexus (formerly Nexus) - Same powerful open source AI worker, new name.',
    type: 'website',
    url: 'https://www.nexus.com/nexus',
    siteName: 'Nexus',
    images: [
      {
        url: '/banner.png',
  ...
  alternates: {
    canonical: 'https://www.nexus.com/nexus',
  },
  robots: {
    index: true,
    follow: true,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'Organization',
            name: 'Nexus',
            alternateName: ['Nexus', 'Nexus', 'Nexus AI'],
            url: 'https://www.nexus.com',
            logo: 'https://www.nexus.com/favicon.png',
            sameAs: [
              'https://github.com/NiS2709',
              'https://x.com/nexus',
              'https://linkedin.com/company/nexus',
            ],
            description:
              'Nexus (formerly known as Nexus) is an open source generalist AI worker that helps you accomplish real-world tasks through natural conversation.',
          }),
        }}
      />
            ...
            itemListElement: [
              {
                ...
                position: 1,
                name: 'Home',
                item: 'https://www.nexus.com',
              },
              {
                '@type': 'ListItem',
                position: 2,
                name: 'Nexus is now Nexus',
                item: 'https://www.nexus.com/nexus',
              },
            ],
          }),
        }}
        ...
        <div className="relative flex flex-col items-center w-full px-4 sm:px-6">
          ...
          <div className="relative z-10 pt-16 sm:pt-24 md:pt-32 mx-auto h-full w-full max-w-6xl flex flex-col items-center justify-center">
            <div className="flex flex-col items-center justify-center gap-3 sm:gap-4 pt-8 sm:pt-20 max-w-4xl mx-auto pb-10">
              {/* Nexus Symbol with grain texture */}
              <div className="relative mb-8 sm:mb-12" style={{ width: '80px', height: '80px' }}>
                ...
                <div
                  ...
                  style={{
                    ...
                    opacity: 0.6,
                    maskImage: 'url(/nexus-symbol.svg)',
                    WebkitMaskImage: 'url(/nexus-symbol.svg)',
                    maskSize: 'contain',
            ...
            <div className="space-y-20 sm:space-y-32 text-center">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3 text-base md:text-lg text-muted-foreground font-medium">
                  <p>Our name changed from Nexus to Nexus</p>
                  <p>Our domain is now nexus.com</p>
                </div>
              </div>
              ...
              <div className="space-y-6">
                ...
                <p className="text-base md:text-lg text-muted-foreground font-medium">
                  Our GitHub repository remains at github.com/NiS2709/nexus
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative z-10 text-center max-w-2xl mx-auto pb-20 pt-12 border-t border-border/50">
            <p className="text-sm text-muted-foreground/60 leading-relaxed font-medium">
              Looking for Nexus? You've found us. Nexus is the evolution of Nexus — the same open
              source AI assistant and generalist AI worker, now with a name that better represents
              our vision. For users searching for "Nexus AI", "Nexus assistant", "Nexus.so", "where is
              Nexus", or "Nexus" — this is the official continuation of the Nexus project under
              the Nexus brand.
            </p>
          </div>
        </div>
