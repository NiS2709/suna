...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Nexus',
    description: 'Replay this Worker conversation on Nexus',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Nexus';
    const description =
      projectData.description ||
      'Replay this Worker conversation on Nexus';
