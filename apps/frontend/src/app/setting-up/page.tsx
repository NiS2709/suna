...
const NexusLoader = lazy(() => import('@/components/ui/nexus-loader').then(mod => ({ default: mod.NexusLoader })));
                ...
                <CardContent className="p-6 h-full">
                  <div className="flex items-center justify-between h-full">
                    ...
                    <div className="h-12 w-12 flex items-center justify-center">
                      <Suspense fallback={<NexusLoader size="small" />}>
                        <NexusLoader size="small" customSize={24} />
                      </Suspense>
                    </div>
                  </div>
                </CardContent>
