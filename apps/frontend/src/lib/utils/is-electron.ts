...
export function isElectron(): boolean {
  ...
  // Check user agent for Electron (we append "Electron/Nexus-Desktop" in main.js)
 ...
 * - Web: returns the web URL (https://nexus.com/auth/callback)
 * - Electron: returns the custom protocol URL (nexus://auth/callback)
 */
