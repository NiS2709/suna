export const clearUserLocalStorage = () => {
  ...
  try {
    ...
    // localStorage.removeItem('nexus-preferred-model-v3');
    localStorage.removeItem('customModels');
    localStorage.removeItem('nexus-model-selection-v2');
    ...
    localStorage.removeItem('nexus_upgrade_dialog_displayed');
