...
export const pricingTiers: PricingTier[] = [
  {
    ...
    description: 'Perfect for trying out Nexus AI Workers',
  ...
  },
  {
    ...
    features: [
      ...
      '5 custom AI Workers - Create Nexus Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '20 custom AI Workers - Create Nexus Workers with custom Knowledge, Tools & Integrations',
  ...
  },
  {
    ...
    features: [
      ...
      '100 custom AI Workers - Create Nexus Workers with custom Knowledge, Tools & Integrations',
