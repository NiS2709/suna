...
import { NexusComputer } from '@/components/nexus-computer';
...
export default function ShareThreadPage() {
  ...
  // Nexus Computer for viewing tool calls
  const { isOpen: isNexusComputerOpen, openPanel } = useNexusComputerStore();
  const [selectedToolData, setSelectedToolData] = React.useState<{
    toolMessages: ToolMessagePair[];
    initialIndex: number;
  } | null>(null);

  // Handle tool press - open Nexus Computer
