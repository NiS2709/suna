...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    const handleDeepLink = async (event: { url: string }) => {
      ...
      // Check for universal links (https://nexus.com/share/xxx or https://staging.nexus.com/share/xxx)
      const isUniversalLink = parsedUrl.scheme === 'https' &&
        (parsedUrl.hostname === 'nexus.com' ||
          parsedUrl.hostname === 'www.nexus.com' ||
          parsedUrl.hostname === 'staging.nexus.com');
      ...
      // Handle custom scheme: nexus://auth/callback
      if (parsedUrl.hostname === 'auth' && parsedUrl.path === 'callback') {
        ...
        // Handle share links: nexus://share/xxx or https://nexus.com/share/xxx
        ...
        if (parsedUrl.path?.startsWith('share/')) {
          ...
          // Custom scheme format: nexus://share/xxx -> hostname=share, path=xxx
