...
import NexusSymbolBlack from '@/assets/brand/nexus-symbol-scale-effect-black.svg';
import NexusSymbolWhite from '@/assets/brand/nexus-symbol-scale-effect-white.svg';
...
function AuthBackgroundLogo() {
  ...
  const SymbolComponent = colorScheme === 'dark' ? NexusSymbolWhite : NexusSymbolBlack;
  ...
  return (
    ...
    >
        ...
        <View style={{ marginBottom: SPACING.logoToTitle }}>
          <NexusLogo variant="logomark" size={24} color={isDark ? 'dark' : 'light'} />
        </View>
