 ...
 * 
 * Note: The backend should return nexus.com URLs that wrap/proxy Stripe,
...
// checkout URLs (should be nexus.com masked URLs, not direct stripe.com)
// ============================================================================
 ...
 * a nexus.com masked URL (not direct stripe.com for compliance)
 */
...
export async function openBillingPortal(returnUrl?: string): Promise<void> {
  ...
  try {
    ...
    const webBillingUrl = process.env.EXPO_PUBLIC_WEB_APP_URL 
      ...
      : 'https://www.nexus.com/subscription';
