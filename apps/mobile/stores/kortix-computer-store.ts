...
export const useNexusComputerStore = create<NexusComputerState>((set, get) => ({
  ...initialState,
...
export const useNexusComputerIsOpen = () =>
  useNexusComputerStore((state) => state.isOpen);
...
export const useNexusComputerSelectedVersion = () =>
  useNexusComputerStore((state) => state.selectedVersion);

export const useNexusComputerSelectedVersionDate = () =>
  useNexusComputerStore((state) => state.selectedVersionDate);

export const useNexusComputerVersionActions = () =>
