...
import NexusSymbolBlack from '@/assets/brand/nexus-symbol.svg';
import NexusSymbolWhite from '@/assets/brand/Symbol.svg';
import LogomarkBlack from '@/assets/brand/Logomark-Black.svg';
import LogomarkWhite from '@/assets/brand/Logomark-White.svg';

interface NexusLogoProps extends Omit<ViewProps, 'style'> {
  size?: number;
...
export function NexusLogo({ 
  ...
  const SymbolComponent = color === 'dark' ? NexusSymbolWhite : NexusSymbolBlack;
