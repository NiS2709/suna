...
const APP_URL = process.env.APP_URL || 'https://nexus.com/';
...
// Register as default protocol handler for nexus://
...
function handleDeepLink(url) {
  ...
  // Convert nexus://auth/callback?code=xxx to https://nexus.com/auth/callback?code=xxx
...
function createWindow() {
  ...
  webContents.setUserAgent(webContents.getUserAgent() + ' Electron/Nexus-Desktop');
