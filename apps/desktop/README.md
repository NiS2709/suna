...
Minimal Electron wrapper for the Nexus web application with deep linking support.

## Features

- Native macOS/Windows/Linux desktop app
- Deep linking for magic link authentication (`nexus://` protocol)
...
By default, it loads `https://nexus.com/`.
...
The app registers the `nexus://` protocol for magic link authentication:

1. User enters email in desktop app
2. Magic link email contains `nexus://auth/callback?code=xxx`
3. User clicks link in email
4. Operating system opens Nexus Desktop app
